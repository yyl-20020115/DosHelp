...
public class HelpDatabase
{
    ...
    /// </summary>
    public HelpTopicCollection Topics => topics;

    /// <summary>
    /// Gets a list of the context strings defined in this database.
    /// </summary>
    public IEnumerable<string> ContextStrings => contextMap.Keys;
...
public class HelpTopicCollection : IList<HelpTopic>
{
    ...
    private readonly List<HelpTopic> m_topics = [];
    ...
    public int Count => m_topics.Count;
    ...
    public bool Contains(HelpTopic topic) => m_topics.Contains(topic);

    public void CopyTo(HelpTopic[] array, int arrayIndex) => m_topics.CopyTo(array, arrayIndex);

    public IEnumerator<HelpTopic> GetEnumerator() => m_topics.GetEnumerator();

    public int IndexOf(HelpTopic topic) => m_topics.IndexOf(topic);
    ...
    IEnumerator IEnumerable.GetEnumerator() => ((IEnumerable)m_topics).GetEnumerator();
}