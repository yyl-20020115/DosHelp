...
{
    private readonly List<HelpLine> lines = [];
    private readonly List<HelpSnippet> m_snippets = [];
    private readonly List<string> m_references = [];
    ...
    public int TopicIndex => Database != null ? Database.Topics.IndexOf(this) : -1;
    ...
    /// </summary>
    public List<HelpLine> Lines => lines;

    public override string ToString() => Title ?? "(Untitled Topic)";
    ...
    /// </summary>
    public List<HelpSnippet> Snippets => m_snippets;
