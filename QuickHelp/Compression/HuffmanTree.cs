...
public class HuffmanTree
{
    ...
    public bool IsSingular => Root != null && Root.IsLeaf;
...
public struct HuffmanDecoder
{
    ...
    public readonly bool HasValue => m_node != null && m_node.IsLeaf;

    public byte Value => !HasValue ? throw new InvalidOperationException("Decoder does not have a value.") : m_node.Value.Symbol;
